...
is_satellite_of(Satellite, Planet) :- is_planet(Planet), orbits(Satellite, Planet).       
            ...
            \begin{figure}[htp]
        		\centering
        		\includegraphics[width=.6\textwidth]{static/interaction-isPlanet-isSatelliteOf.PNG}
            ...
            \begin{figure}[htp]
                \centering
                \includegraphics[width=.6\textwidth]{static/interaction-nonGroundPlanetSatellite.PNG}
...
all_satellites(Planet, Satellites) :- findall(Satellite, is_satellite_of(Satellite, Planet), Satellites).
            ...
            \begin{figure}[htp]
                \centering
                \includegraphics{static/interaction-allSatellites.PNG}
                \caption{Interaction for All Satellites Function}
                \label{fig:figure}
            \end{figure}
	\end{enumerate}
	...
	\begin{enumerate}
		...
		\item (6 pts) (\textbf{\uline{{PROGRAMMING}}}) Use Common LISP to implement the functions below and demonstrate the behavior of each function with a listing of your interaction with the language environment. \textbf{Do not use imperative constructs}.
		      ...
		      \begin{itemize}
                ...
                \begin{figure}[htp]
            		\centering
            		\includegraphics[width=.7\textwidth]{static/interaction-isMember.PNG}
            		\caption{Interaction for Ground Queries}
            		\label{fig:figure}
            	\end{figure}
                ...
                \begin{figure}[htp]
            		\centering
            		\includegraphics[width=.7\textwidth]{static/interaction-equal-setsp.PNG}
            		\caption{Interaction for Ground Queries}
            		\label{fig:figure}
            	\end{figure}
	...
	\begin{enumerate}
		...
		\item (3 pts) (\textbf{\uline{PROGRAMMING}}) Use Common LISP to define two stacks (\texttt{stack1} and \texttt{stack2} as global variables to hold the collection, and implement functions \texttt{enqueue} and \texttt{dequeue}.
            ...
            \begin{figure}[htp]
                \centering
                \includegraphics[width=.7\textwidth]{static/interaction-enqueue-dequeue.PNG}
		...
		\item (2 pts) (\textbf{\uline{PROGRAMMING}}) Implement operations \textit{head}, \textit{tail} and \textit{cons} in Prolog and demonstrate their usage.
            ...
            \begin{figure}[htp]
                \centering
                \includegraphics[width=.7\textwidth]{static/interaction-head-tails-cons.PNG}
                \caption{Interaction for Ground Queries}
                \label{fig:figure}
            \end{figure}
	...
	\begin{enumerate}
		...
		\item (3 pts) (\uline{\textbf{PROGRAMMING}} Map your definition into a Common LISP function.
            ...
            \begin{figure}[htp]
                \centering
                \includegraphics[width=.6\textwidth]{static/interaction-compress.PNG}
