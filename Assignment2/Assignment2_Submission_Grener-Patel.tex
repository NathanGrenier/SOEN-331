...
\begin{spacing}{1.5}
    ...
    \begin{enumerate}
        ...
        \underline{Solution:}
        The AIRPORT should be represented with a set to ensure that there are no duplicate airport ids. The CITY should be represented with a bag due to the need for repeating cities and an unbounded amount of them. The airports variable should be represented as a partial function that maps each airport id to its corresponding city.
        It should be unordered because the order of insertion doesn't matter.
        ...
        \begin{align*}
            ...
            &\oplus (AirportDoesNotExist \lor AirportAlreadyExists)
        \end{align*}
